...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        /// <summary>
        /// Метод увольняющий работников до нужного количества
        /// </summary>
        /// <param name="minState"></param>
        public void DeleteWorkerUntil(int minState)
        {
            for (int i = this.Workers.Count; i > minState; i--)
            {
                this.Workers.RemoveAt(1);
            }
        }
